...
class WorkTypesControllerTest < ActionController::TestCase
  ...
  test "should create work_type" do
    assert_difference('WorkType.count') do
      post :create, work_type: { facility_id: @work_type.facility_id, metric: @work_type.metric, name: @work_type.name, price: @work_type.price }
    end
  ...
  test "should update work_type" do
    patch :update, id: @work_type, work_type: { facility_id: @work_type.facility_id, metric: @work_type.metric, name: @work_type.name, price: @work_type.price }
    assert_redirected_to work_type_path(assigns(:work_type))
  end
